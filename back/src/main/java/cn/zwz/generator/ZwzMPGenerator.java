...
public class ZwzMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.zwz.modules.doctor.entity";

    /**
     * dao对应包 【注意修改后需到cn.zwz.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.zwz.modules.doctor.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.zwz.modules.doctor.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.zwz.modules.doctor.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.zwz.modules.doctor.controller";
